<!-- Navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <div href="#" class="brand-link text-center">
        <span class="brand-text font-weight-light">FandomEmporium</span>
</div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a href="{{ url('admin/customer/list') }}" class="nav-link {{ request()->is('admin/customer/list') ? 'active' : '' }}">
            ...
            <li class="nav-item">
            <a href="{{ url('admin/orders/list') }}" class="nav-link {{ request()->is('admin/orders/list') || request()->is('admin/orders/detail/*') ? 'active' : '' }}">
            ...
            <li class="nav-item">
            <a href="{{ url('admin/reviews/list') }}" class="nav-link {{ request()->is('admin/reviews/list') ? 'active' : '' }}">
